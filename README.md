...
**Agregator pogody z wielu źródeł (REST):** System odpytujący 3 różne publiczne API pogodowe, uśredniający wyniki i prezentujący je w ujednoliconym formacie JSON. (1 osoba)
...
**Michał Kucharski 34469** - projekt wykonany jako zadanie zaliczeniowe.
